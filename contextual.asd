...
(defsystem :contextual/test
  ...
  :perform (test-op (o s)
             ...
             (symbol-call :contextual-arrow-test :run-all-tests!)
             (symbol-call :contextual-either-test :run-all-tests!)
             (symbol-call :contextual-arrow-choice-test :run-all-tests!)))
